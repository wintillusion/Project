...
<%@ page import = "member.vo.MemberBean" %>
 ...
 //	 System.out.println("passChk Form : "+ pass); //패스워드 나오는지 체크 
...
<body>
<form action="passChkPro.member?id=<%=id%>" method="post" name="passChange">
<h2>PASSWORD CHANGE</h2>
<article>
<input type="hidden" name="id" id="id" value="<%=memberBean.getId() %>"/>
	<div class="tbox">
			<input type="password" name="passchk" id="passchk" placeholder="@현재비밀번호 확인"/>
			<br><span id="psChk"></span>
			
	</div>
			<input class="btn" type="submit" value="비밀번호 변경하기">
