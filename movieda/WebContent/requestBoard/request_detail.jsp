...
function deleteForm(){
	location.href="requestDeletePro.request?num=<%=requestBean.getNum()%>&page=<%=nowPage%>";
}
...
<body>
	<h2 style="text-align:center" id="begin">REQUEST</h2>
	<article>
		<div>
		<section>
		...
		<input type="button" onclick="javascript:wrtieForm()" value="글쓰기">
