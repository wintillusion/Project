...
<%
	...
	ArrayList<RequestBean> requestLikeList=(ArrayList<RequestBean>)request.getAttribute("requestLikeList");	//사용하기 위해서 형변환을 시켜줘야함.
...
<h2 style="text-align:center">영화 리뷰를 요청해보세요!</h2>
...
<td>
				...
				<%} %>
				<%}else{ %><%}%><!-- 들여쓰고 화살표를 넣는 것. -->
					<a style="color:black" href="requestDetail.request?num=<%=requestList.get(i).getNum() %>&page=<%=nowPage %>#begin">
