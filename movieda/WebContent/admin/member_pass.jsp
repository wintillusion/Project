...
// 	 System.out.println("관리자용 passChange Form : "+ pass); //패스워드 나오는지 체크

if (!(session.getAttribute("id") == null) || (((String) session.getAttribute("id")).equals("admin"))){
	    	id=(String)session.getAttribute("id");	//세션 아이디가 null이 아니고 id값이 admin일때
	    }else {
	    	out.println("<script>");
	    	out.println("alert('관리자 로그인페이지입니다.')");
...
<body>
<form action="passPro.admin" method="post" name="passChange" onsubmit="return checkValue(this)">
